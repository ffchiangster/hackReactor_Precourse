(function() {
  ...
  _.last = function(array, n) {
    ...
    n < array.length ? array.slice(array.length - n, array.length) : array.slice(0, n);
  };
  ...
  _.reduce = function(collection, iterator, accumulator) {
    ...
    for(var i in collection){
      ...
      if(total === undefined && is_first_time === true){
        total = collection[0];
        is_first_time = false;
        continue;
      }
  ...
  _.every = function(collection, iterator) {
    return _.reduce(collection, function(reduced, ele){
      if (iterator === undefined && Boolean(ele)){
        return true;
      }
      else if (iterator !== undefined && reduced && Boolean(iterator(ele))){
        return true;
      }
      return false;
    }, true);
  ...
  _.shuffle = function(array) {
    ...
    for(var i = 0; i < array.length; i++){
      newArr.push(copy.pop(Math.random() * (copy.length)))
    }
    return newArr;
  };
